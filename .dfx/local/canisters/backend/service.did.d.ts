...
export interface Contract { 'playerId' : PlayerId }
...
export type Result = { 'ok' : UpdateAgentDTO } |
  { 'err' : Error };
export type Result_1 = { 'ok' : null } |
  { 'err' : Error };
export type Result_2 = { 'ok' : boolean } |
  { 'err' : Error };
export type Result_3 = { 'ok' : Array<ContractDTO> } |
  { 'err' : Error };
export type Result_4 = { 'ok' : AgentDTO } |
  { 'err' : Error };
export type Result_5 = { 'ok' : AddContractDTO } |
  { 'err' : Error };
