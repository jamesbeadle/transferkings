...
var Vt = [],
  kt = [],
  fs = typeof Uint8Array < "u" ? Uint8Array : Array,
  sr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
for (var we = 0, hs = sr.length; we < hs; ++we)
  (Vt[we] = sr[we]), (kt[sr.charCodeAt(we)] = we);
kt[45] = 62;
kt[95] = 63;
function Kn(e) {
  var t = e.length;
...
function ws(e) {
  return (
    Vt[(e >> 18) & 63] + Vt[(e >> 12) & 63] + Vt[(e >> 6) & 63] + Vt[e & 63]
  );
}
function ys(e, t, r) {
...
function gs(e) {
  for (
    ...
    u.push(ys(e, g, g + d > c ? c : g + d));
  return (
    o === 1
      ? ((t = e[r - 1]), u.push(Vt[t >> 2] + Vt[(t << 4) & 63] + "=="))
      : o === 2 &&
        ((t = (e[r - 2] << 8) + e[r - 1]),
        u.push(Vt[t >> 10] + Vt[(t >> 4) & 63] + Vt[(t << 2) & 63] + "=")),
    u.join("")
  );
}
var ve = {};
/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ ve.read =
  function (e, t, r, o, u) {
    var d,
      g,
      c = u * 8 - o - 1,
      ...
      k = e[t + L];
    for (
      L += D, d = k & ((1 << -N) - 1), k >>= -N, N += c;
      N > 0;
      d = d * 256 + e[t + L], L += D, N -= 8
    );
    for (
      g = d & ((1 << -N) - 1), d >>= -N, N += o;
      N > 0;
      g = g * 256 + e[t + L], L += D, N -= 8
    );
    if (d === 0) d = 1 - B;
    else {
      if (d === b) return g ? NaN : (k ? -1 : 1) * (1 / 0);
      (g = g + Math.pow(2, o)), (d = d - B);
    }
    return (k ? -1 : 1) * g * Math.pow(2, d - o);
  };
ve.write = function (e, t, r, o, u, d) {
  var g,
    c,
    b,
    B = d * 8 - u - 1,
    N = (1 << B) - 1,
    L = N >> 1,
    D = u === 23 ? Math.pow(2, -24) - Math.pow(2, -77) : 0,
    k = o ? 0 : d - 1,
    j = o ? 1 : -1,
    X = t < 0 || (t === 0 && 1 / t < 0) ? 1 : 0;
  for (
    t = Math.abs(t),
      isNaN(t) || t === 1 / 0
        ...
        : ((g = Math.floor(Math.log(t) / Math.LN2)),
          ...
          g + L >= 1 ? (t += D / b) : (t += D * Math.pow(2, 1 - L)),
          t * b >= 2 && (g++, (b /= 2)),
          g + L >= N
            ? ((c = 0), (g = N))
            : g + L >= 1
    ...
    u >= 8;
    e[r + k] = c & 255, k += j, c /= 256, u -= 8
  );
  for (
    g = (g << u) | c, B += u;
    B > 0;
    e[r + k] = g & 255, k += j, g /= 256, B -= 8
  );
  e[r + k - j] |= X * 128;
};
/*!
 ...
 */ (function (e) {
  const t = Fe,
    ...
    o =
      typeof Symbol == "function" && typeof Symbol.for == "function"
        ...
        : null;
  (e.Buffer = c), (e.SlowBuffer = ot), (e.INSPECT_MAX_BYTES = 50);
  const u = 2147483647;
  (e.kMaxLength = u),
  ...
  c.poolSize = 8192;
  function b(h, s, a) {
    if (typeof h == "string") return D(h, s);
    if (ArrayBuffer.isView(h)) return j(h);
    if (h == null)
      throw new TypeError(
  ...
  function rt(h) {
    ...
    if (h.length !== void 0)
      return typeof h.length != "number" || O(h.length) ? g(0) : k(h);
    if (h.type === "Buffer" && Array.isArray(h.data)) return k(h.data);
  }
  function mt(h) {
    if (h >= u)
      throw new RangeError(
  ...
  (c.prototype.swap16 = function () {
    ...
    for (let a = 0; a < s; a += 2) Y(this, a, a + 1);
    return this;
  }),
    (c.prototype.swap32 = function () {
      ...
      for (let a = 0; a < s; a += 4) Y(this, a, a + 3), Y(this, a + 1, a + 2);
      return this;
    }),
    ...
    (c.prototype.compare = function (s, a, m, A, R) {
      if (
        (F(s, Uint8Array) && (s = c.from(s, s.offset, s.byteLength)),
        !c.isBuffer(s))
      )
      ...
      if (
        ...
        a < 0 || m > s.length || A < 0 || R > this.length)
      )
        throw new RangeError("out of range index");
      if (A >= R && a >= m) return 0;
      if (A >= R) return -1;
      if (a >= m) return 1;
      if (((a >>>= 0), (m >>>= 0), (A >>>= 0), (R >>>= 0), this === s))
        return 0;
      let v = R - A,
        Q = m - a;
      const lt = Math.min(v, Q),
        it = this.slice(A, R),
        Z = s.slice(a, m);
      ...
      return v < Q ? -1 : Q < v ? 1 : 0;
    });
  function W(h, s, a, m, A) {
    ...
    if ((typeof s == "string" && (s = c.from(s, m)), c.isBuffer(s)))
      return s.length === 0 ? -1 : J(h, s, a, m, A);
    if (typeof s == "number")
      return (
        (s = s & 255),
  ...
  function J(h, s, a, m, A) {
    ...
    function lt(Z, Et) {
      return R === 1 ? Z[Et] : Z.readUInt16BE(Et * R);
    }
    let it;
    if (A) {
      let Z = -1;
      for (it = a; it < v; it++)
        if (lt(h, it) === lt(s, Z === -1 ? 0 : it - Z)) {
          if ((Z === -1 && (Z = it), it - Z + 1 === Q)) return Z * R;
        } else Z !== -1 && (it -= it - Z), (Z = -1);
    } else
      for (a + Q > v && (a = v - Q), it = a; it >= 0; it--) {
        let Z = !0;
        for (let Et = 0; Et < Q; Et++)
          if (lt(h, it + Et) !== lt(s, Et)) {
            Z = !1;
            break;
          }
        if (Z) return it;
  ...
  (c.prototype.includes = function (s, a, m) {
    ...
    (c.prototype.indexOf = function (s, a, m) {
      return W(this, s, a, m, !0);
    }),
    (c.prototype.lastIndexOf = function (s, a, m) {
      return W(this, s, a, m, !1);
    });
  function tt(h, s, a, m) {
    a = Number(a) || 0;
    const A = h.length - a;
    ...
    let v;
    for (v = 0; v < m; ++v) {
      const Q = parseInt(s.substr(v * 2, 2), 16);
      if (O(Q)) return v;
      h[a + v] = Q;
    }
    return v;
  ...
  (c.prototype.write = function (s, a, m, A) {
    ...
    for (;;)
      switch (A) {
        case "hex":
          return tt(this, s, a, m);
        case "utf8":
        case "utf-8":
          return at(this, s, a, m);
        case "ascii":
        case "latin1":
        case "binary":
          return M(this, s, a, m);
        case "base64":
          return yt(this, s, a, m);
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
          return ht(this, s, a, m);
        default:
  ...
  function Pt(h) {
    const s = h.length;
    if (s <= bt) return String.fromCharCode.apply(String, h);
    let a = "",
      m = 0;
    for (; m < s; )
      a += String.fromCharCode.apply(String, h.slice(m, (m += bt)));
    return a;
  }
  function Ft(h, s, a) {
    let m = "";
    a = Math.min(h.length, a);
    for (let A = s; A < a; ++A) m += String.fromCharCode(h[A] & 127);
    return m;
  }
  function G(h, s, a) {
    let m = "";
    a = Math.min(h.length, a);
    for (let A = s; A < a; ++A) m += String.fromCharCode(h[A]);
    return m;
  }
  function P(h, s, a) {
    const m = h.length;
  ...
  (c.prototype.readUintLE = c.prototype.readUIntLE =
    function (s, a, m) {
      (s = s >>> 0), (a = a >>> 0), m || C(s, a, this.length);
      let A = this[s],
        R = 1,
        v = 0;
      for (; ++v < a && (R *= 256); ) A += this[s + v] * R;
      return A;
    }),
    (c.prototype.readUintBE = c.prototype.readUIntBE =
      function (s, a, m) {
        ...
        let A = this[s + --a],
          R = 1;
        for (; a > 0 && (R *= 256); ) A += this[s + --a] * R;
        return A;
      }),
    (c.prototype.readUint8 = c.prototype.readUInt8 =
      function (s, a) {
        return (s = s >>> 0), a || C(s, 1, this.length), this[s];
      }),
    (c.prototype.readUint16LE = c.prototype.readUInt16LE =
      function (s, a) {
        return (
          (s = s >>> 0), a || C(s, 2, this.length), this[s] | (this[s + 1] << 8)
        );
      }),
    (c.prototype.readUint16BE = c.prototype.readUInt16BE =
      function (s, a) {
        return (
          (s = s >>> 0), a || C(s, 2, this.length), (this[s] << 8) | this[s + 1]
        );
      }),
    ...
    (c.prototype.readFloatLE = function (s, a) {
      return (
        (s = s >>> 0), a || C(s, 4, this.length), r.read(this, s, !0, 23, 4)
      );
    }),
    (c.prototype.readFloatBE = function (s, a) {
      return (
        (s = s >>> 0), a || C(s, 4, this.length), r.read(this, s, !1, 23, 4)
      );
    }),
    (c.prototype.readDoubleLE = function (s, a) {
      return (
        (s = s >>> 0), a || C(s, 8, this.length), r.read(this, s, !0, 52, 8)
      );
    }),
    (c.prototype.readDoubleBE = function (s, a) {
      return (
        (s = s >>> 0), a || C(s, 8, this.length), r.read(this, s, !1, 52, 8)
      );
    });
  function H(h, s, a, m, A, R) {
    if (!c.isBuffer(h))
  ...
  (c.prototype.writeBigUInt64LE = V(function (s, a = 0) {
    return st(this, s, a, BigInt(0), BigInt("0xffffffffffffffff"));
  })),
    (c.prototype.writeBigUInt64BE = V(function (s, a = 0) {
      return y(this, s, a, BigInt(0), BigInt("0xffffffffffffffff"));
    })),
    (c.prototype.writeIntLE = function (s, a, m, A) {
      if (((s = +s), (a = a >>> 0), !A)) {
        const lt = Math.pow(2, 8 * m - 1);
        H(this, s, a, m, lt - 1, -lt);
      }
      let R = 0,
        v = 1,
        Q = 0;
      for (this[a] = s & 255; ++R < m && (v *= 256); )
        s < 0 && Q === 0 && this[a + R - 1] !== 0 && (Q = 1),
          (this[a + R] = (((s / v) >> 0) - Q) & 255);
      return a + m;
    }),
    (c.prototype.writeIntBE = function (s, a, m, A) {
      if (((s = +s), (a = a >>> 0), !A)) {
        const lt = Math.pow(2, 8 * m - 1);
        H(this, s, a, m, lt - 1, -lt);
      }
    ...
    (c.prototype.writeInt32LE = function (s, a, m) {
      return (
        (s = +s),
        (a = a >>> 0),
        m || H(this, s, a, 4, 2147483647, -2147483648),
        (this[a] = s & 255),
        (this[a + 1] = s >>> 8),
        (this[a + 2] = s >>> 16),
        (this[a + 3] = s >>> 24),
  ...
  (c.prototype.writeDoubleLE = function (s, a, m) {
    return gt(this, s, a, !0, m);
  }),
    (c.prototype.writeDoubleBE = function (s, a, m) {
      return gt(this, s, a, !1, m);
    }),
    (c.prototype.copy = function (s, a, m, A) {
      ...
      A > this.length && (A = this.length),
        s.length - a < A - m && (A = s.length - a + m);
      const R = A - m;
      return (
        this === s && typeof Uint8Array.prototype.copyWithin == "function"
          ? this.copyWithin(a, m, A)
          : Uint8Array.prototype.set.call(s, this.subarray(m, A), a),
        R
      );
    }),
    (c.prototype.fill = function (s, a, m, A) {
      if (typeof s == "string") {
        if (
          (typeof a == "string"
      ...
      if (typeof s == "number") for (R = a; R < m; ++R) this[R] = s;
        ...
        const v = c.isBuffer(s) ? s : c.from(s, A),
          Q = v.length;
        if (Q === 0)
          throw new TypeError(
            'The value "' + s + '" is invalid for argument "value"',
          );
        for (R = 0; R < m - a; ++R) this[R + a] = v[R % Q];
      }
      return this;
    });
  const $ = {};
  ...
  function _(h, s, a, m, A, R) {
    if (h > a || h < s) {
      const v = typeof s == "bigint" ? "n" : "";
      let Q;
      throw (
        (s === 0 || s === BigInt(0)
          ? (Q = `>= 0${v} and < 2${v} ** ${(R + 1) * 8}${v}`)
          : (Q = `>= -(2${v} ** ${(R + 1) * 8 - 1}${v}) and < 2 ** ${(R + 1) * 8 - 1}${v}`),
        new $.ERR_OUT_OF_RANGE("value", Q, h))
      );
    }
    x(m, A, R);
  }
  function T(h, s) {
    if (typeof h != "number") throw new $.ERR_INVALID_ARG_TYPE(s, "number", h);
  }
  function S(h, s, a) {
    throw Math.floor(h) !== h
      ? (T(h, a), new $.ERR_OUT_OF_RANGE("offset", "an integer", h))
      : s < 0
        ? new $.ERR_BUFFER_OUT_OF_BOUNDS()
        : new $.ERR_OUT_OF_RANGE("offset", `>= 0 and <= ${s}`, h);
  }
  ...
  function n(h, s) {
    ...
    for (let v = 0; v < m; ++v) {
      if (((a = h.charCodeAt(v)), a > 55295 && a < 57344)) {
        ...
        if (a < 56320) {
          (s -= 3) > -1 && R.push(239, 191, 189), (A = a);
          continue;
        }
        a = (((A - 55296) << 10) | (a - 56320)) + 65536;
      } else A && (s -= 3) > -1 && R.push(239, 191, 189);
      if (((A = null), a < 128)) {
        if ((s -= 1) < 0) break;
        R.push(a);
      } else if (a < 2048) {
  ...
  function E(h, s, a, m) {
    let A;
    for (A = 0; A < m && !(A + a >= s.length || A >= h.length); ++A)
      s[A + a] = h[A];
    return A;
  }
  function F(h, s) {
  ...
  const z = (function () {
    ...
    for (let a = 0; a < 16; ++a) {
      const m = a * 16;
      for (let A = 0; A < 16; ++A) s[m + A] = h[a] + h[A];
    }
    return s;
  })();
  function V(h) {
    return typeof BigInt > "u" ? et : h;
  }
  function et() {
...
const Ve = "abcdefghijklmnopqrstuvwxyz234567",
  _e = Object.create(null);
for (let e = 0; e < Ve.length; e++) _e[Ve[e]] = e;
_e[0] = _e.o;
_e[1] = _e.i;
function xs(e) {
  let t = 0,
...
function Yn(e) {
  return typeof e == "string" && (e = zn(e)), Dr(e), e;
}
function Bs(...e) {
  let t = 0;
...
function Pr(e) {
  const t = (o) => e().update(Yn(o)).digest(),
    r = e();
  return (
...
function Ss(e = 32) {
  if (or && typeof or.getRandomValues == "function")
    return or.getRandomValues(new Uint8Array(e));
...
function Ts(e, t, r, o) {
  ...
  const u = BigInt(32),
    ...
    b = o ? 4 : 0,
    B = o ? 0 : 4;
  e.setUint32(t + b, g, o), e.setUint32(t + B, c, o);
}
const Us = (e, t, r) => (e & t) ^ (~e & r),
  Ns = (e, t, r) => (e & t) ^ (e & r) ^ (t & r);
class Wn extends As {
  constructor(t, r, o, u) {
    super(),
      (this.blockLen = t),
  ...
  digestInto(t) {
    an(this), Is(t, this), (this.finished = !0);
    ...
    Ts(o, u - 8, BigInt(this.length * 8), d), this.process(o, 0);
    const c = ar(t),
      b = this.outputLen;
    ...
    for (let L = 0; L < B; L++) c.setUint32(4 * L, N[L], d);
  }
  digest() {
...
class qn extends Wn {
  ...
  process(t, r) {
    ...
    for (let L = 16; L < 64; L++) {
      const D = ee[L - 15],
        k = ee[L - 2],
        j = Yt(D, 7) ^ Yt(D, 18) ^ (D >>> 3),
        X = Yt(k, 17) ^ Yt(k, 19) ^ (k >>> 10);
      ee[L] = (X + ee[L - 7] + j + ee[L - 16]) | 0;
    }
    let { A: o, B: u, C: d, D: g, E: c, F: b, G: B, H: N } = this;
    for (let L = 0; L < 64; L++) {
      const D = Yt(c, 6) ^ Yt(c, 11) ^ Yt(c, 25),
        k = (N + D + Us(c, b, B) + Fs[L] + ee[L]) | 0,
        X = ((Yt(o, 2) ^ Yt(o, 13) ^ Yt(o, 22)) + Ns(o, u, d)) | 0;
      (N = B),
        (B = b),
        (b = c),
        (c = (g + k) | 0),
...
const Rs = Pr(() => new qn()),
  Ls = Pr(() => new vs());
function Os(e) {
  return Ls.create().update(new Uint8Array(e)).digest();
}
const Pe = "__principal__",
  Ds = 2,
  un = 4,
  Ps = "aaaaa-aa",
  Ms = (e) => {
  ...
  Cs = (e) => e.reduce((t, r) => t + r.toString(16).padStart(2, "0"), "");
class ce {
  constructor(t) {
    (this._arr = t), (this._isPrincipal = !0);
  }
  static anonymous() {
    return new this(new Uint8Array([un]));
  }
  static managementCanister() {
    return this.fromHex(Ps);
  }
  static selfAuthenticating(t) {
    const r = Os(t);
    return new this(new Uint8Array([...r, Ds]));
  }
  static from(t) {
    if (typeof t == "string") return ce.fromText(t);
    if (Object.getPrototypeOf(t) === Uint8Array.prototype) return new ce(t);
    if (typeof t == "object" && t !== null && t._isPrincipal === !0)
      return new ce(t._arr);
    throw new Error(`Impossible to convert ${JSON.stringify(t)} to Principal.`);
  }
  static fromHex(t) {
    return new this(Ms(t));
  }
  static fromText(t) {
    let r = t;
    if (t.includes(Pe)) {
  ...
  isAnonymous() {
    return this._arr.byteLength === 1 && this._arr[0] === un;
  }
  toUint8Array() {
    return this._arr;
  }
  toHex() {
    return Cs(this._arr).toUpperCase();
  }
  toText() {
    const t = new ArrayBuffer(4);
    new DataView(t).setUint32(0, Es(this._arr));
...
class Mr {
  constructor(t, r = t?.byteLength || 0) {
    (this._buffer = br(t || new ArrayBuffer(0))),
      (this._view = new Uint8Array(this._buffer, 0, r));
  }
  get buffer() {
    return br(this._view.slice());
  }
  get byteLength() {
...
function $s(e, t) {
  return e.byteLength < t && Vn(), e.read(t);
}
function cn(e) {
  const t = e.readUint8();
...
function Jn(e, t) {
  e = BigInt(e);
  const r = new Mr(new ArrayBuffer(Math.min(1, t)), 0);
  let o = 0,
    u = BigInt(256),
    d = BigInt(0),
    g = Number(e % u);
...
class Zn extends $r {
  ...
  covariant(t) {
    ...
    throw new Error(`Invalid ${this.display()} argument: ${Re(t)}`);
  }
  encodeValue(t) {
...
class Qe extends $r {
  ...
  covariant(t) {
    const r = Er(this._bits - 1) * BigInt(-1),
      o = Er(this._bits - 1) - BigInt(1);
    let u = !1;
...
class er extends Hs {
  constructor() {
    super(...arguments), (this._id = er._counter++), (this._type = void 0);
  }
  accept(t, r) {
...
function Re(e) {
  ...
  return t && t.length > hn ? t.substring(0, hn - 3) + "..." : t;
}
new Zn(32);
new Zn(64);
new Qe(8);
 ...
 */ (function (e) {
  ...
  c.poolSize = 8192;
  function b(f, n, i) {
    if (typeof f == "string") return D(f, n);
    if (ArrayBuffer.isView(f)) return j(f);
    if (f == null)
      throw new TypeError(
        "The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type " +
          typeof f,
  ...
  function rt(f) {
    ...
    if (f.length !== void 0)
      return typeof f.length != "number" || S(f.length) ? g(0) : k(f);
  ...
  (c.prototype.swap16 = function () {
    ...
    if (n % 2 !== 0)
      throw new RangeError("Buffer size must be a multiple of 16-bits");
    for (var i = 0; i < n; i += 2) Y(this, i, i + 1);
    return this;
  }),
    (c.prototype.swap32 = function () {
      var n = this.length;
      if (n % 4 !== 0)
        throw new RangeError("Buffer size must be a multiple of 32-bits");
      for (var i = 0; i < n; i += 4) Y(this, i, i + 3), Y(this, i + 1, i + 2);
      return this;
    }),
    (c.prototype.swap64 = function () {
      var n = this.length;
  ...
  function J(f, n, i, l, p) {
    ...
    if (p) {
      var et = -1;
      for (V = i; V < F; V++)
        if (z(f, V) === z(n, et === -1 ? 0 : V - et)) {
          if ((et === -1 && (et = V), V - et + 1 === O)) return et * E;
        } else et !== -1 && (V -= V - et), (et = -1);
    } else
      for (i + O > F && (i = F - O), V = i; V >= 0; V--) {
        for (var h = !0, s = 0; s < O; s++)
          if (z(f, V + s) !== z(n, s)) {
            h = !1;
            break;
          }
  ...
  (c.prototype.includes = function (n, i, l) {
    ...
    (c.prototype.indexOf = function (n, i, l) {
      return W(this, n, i, l, !0);
    }),
    (c.prototype.lastIndexOf = function (n, i, l) {
      return W(this, n, i, l, !1);
    });
  function tt(f, n, i, l) {
    i = Number(i) || 0;
    var p = f.length - i;
    ...
    l > E / 2 && (l = E / 2);
    for (var F = 0; F < l; ++F) {
      var O = parseInt(n.substr(F * 2, 2), 16);
      if (S(O)) return F;
      f[i + F] = O;
    }
    return F;
  ...
  (c.prototype.write = function (n, i, l, p) {
    ...
    for (var F = !1; ; )
      switch (p) {
        case "hex":
          return tt(this, n, i, l);
        case "utf8":
        case "utf-8":
          return at(this, n, i, l);
        case "ascii":
        case "latin1":
        case "binary":
          return M(this, n, i, l);
        case "base64":
          return yt(this, n, i, l);
        case "ucs2":
        case "ucs-2":
        case "utf16le":
        case "utf-16le":
          return ht(this, n, i, l);
        default:
  ...
  function Pt(f) {
    var n = f.length;
    if (n <= bt) return String.fromCharCode.apply(String, f);
    for (var i = "", l = 0; l < n; )
      i += String.fromCharCode.apply(String, f.slice(l, (l += bt)));
    return i;
  }
  function Ft(f, n, i) {
    var l = "";
  ...
  (c.prototype.readUintLE = c.prototype.readUIntLE =
    function (n, i, l) {
      (n = n >>> 0), (i = i >>> 0), l || C(n, i, this.length);
    ...
    (c.prototype.readUint8 = c.prototype.readUInt8 =
      function (n, i) {
        return (n = n >>> 0), i || C(n, 1, this.length), this[n];
      }),
    (c.prototype.readUint16LE = c.prototype.readUInt16LE =
      function (n, i) {
        return (
          (n = n >>> 0), i || C(n, 2, this.length), this[n] | (this[n + 1] << 8)
        );
      }),
    (c.prototype.readUint16BE = c.prototype.readUInt16BE =
      function (n, i) {
        return (
          (n = n >>> 0), i || C(n, 2, this.length), (this[n] << 8) | this[n + 1]
        );
      }),
    (c.prototype.readUint32LE = c.prototype.readUInt32LE =
      function (n, i) {
    ...
    (c.prototype.readFloatLE = function (n, i) {
      return (
        (n = n >>> 0), i || C(n, 4, this.length), r.read(this, n, !0, 23, 4)
      );
    }),
    (c.prototype.readFloatBE = function (n, i) {
      return (
        (n = n >>> 0), i || C(n, 4, this.length), r.read(this, n, !1, 23, 4)
      );
    }),
    (c.prototype.readDoubleLE = function (n, i) {
      return (
        (n = n >>> 0), i || C(n, 8, this.length), r.read(this, n, !0, 52, 8)
      );
    }),
    (c.prototype.readDoubleBE = function (n, i) {
      return (
        (n = n >>> 0), i || C(n, 8, this.length), r.read(this, n, !1, 52, 8)
      );
    });
  function H(f, n, i, l, p, E) {
    if (!c.isBuffer(f))
      throw new TypeError('"buffer" argument must be a Buffer instance');
    if (n > p || n < E)
      throw new RangeError('"value" argument is out of bounds');
  ...
  (c.prototype.writeUintLE = c.prototype.writeUIntLE =
    ...
    (c.prototype.writeIntLE = function (n, i, l, p) {
      ...
      var F = 0,
        O = 1,
        z = 0;
      for (this[i] = n & 255; ++F < l && (O *= 256); )
        n < 0 && z === 0 && this[i + F - 1] !== 0 && (z = 1),
          (this[i + F] = (((n / O) >> 0) - z) & 255);
      return i + l;
    }),
    ...
    (c.prototype.writeInt32LE = function (n, i, l) {
      return (
        (n = +n),
        (i = i >>> 0),
        l || H(this, n, i, 4, 2147483647, -2147483648),
        (this[i] = n & 255),
        (this[i + 1] = n >>> 8),
        (this[i + 2] = n >>> 16),
        (this[i + 3] = n >>> 24),
  ...
  (c.prototype.writeDoubleLE = function (n, i, l) {
    ...
    (c.prototype.fill = function (n, i, l, p) {
      ...
      if (typeof n == "number") for (F = i; F < l; ++F) this[F] = n;
        ...
        var O = c.isBuffer(n) ? n : c.from(n, p),
          z = O.length;
        if (z === 0)
          throw new TypeError(
            'The value "' + n + '" is invalid for argument "value"',
          );
        for (F = 0; F < l - i; ++F) this[F + i] = O[F % z];
      }
      return this;
    });
  var ut = /[^+/0-9A-Za-z-_]/g;
  function gt(f) {
    if (((f = f.split("=")[0]), (f = f.trim().replace(ut, "")), f.length < 2))
      return "";
  ...
  (function (t) {
    ...
    function j(W) {
      var J,
        tt,
        at,
        M = (y.prototype = { constructor: y, toString: null, valueOf: null }),
        yt = new y(1),
        ht = 20,
        ft = 4,
        At = -7,
      ...
      function y(w, x) {
        ...
        if (x == null) {
          ...
          if ((n = typeof w == "number") && w * 0 == 0) {
            if (((p.s = 1 / w < 0 ? ((w = -w), -1) : 1), w === ~~w)) {
              ...
              U > Ft ? (p.c = p.e = null) : ((p.e = U), (p.c = [w]));
              return;
            }
            l = String(w);
          } else {
            if (!o.test((l = String(w)))) return at(p, l, n);
          ...
          if ((ot(x, 2, H.length, "Base"), x == 10 && st))
            return (p = new y(w)), $(p, ht + p.e + 1, ft);
          if (((l = String(w)), (n = typeof w == "number"))) {
            if (w * 0 != 0) return at(p, l, n, x);
            if (
          ...
          for (_ = H.slice(0, x), U = f = 0, i = l.length; f < i; f++)
        ...
        if ((l = l.slice(f, ++i))) {
          if (((i -= f), n && y.DEBUG && i > 15 && (w > N || w !== d(w))))
            throw Error(c + p.s * w);
          if ((U = U - f - 1) > Ft) p.c = p.e = null;
          else if (U < Pt) p.c = [(p.e = 0)];
          else {
            if (
              ((p.e = U),
              (p.c = []),
              ...
              for (f && p.c.push(+l.slice(0, f)), i -= B; f < i; )
                p.c.push(+l.slice(f, (f += B)));
              f = B - (l = l.slice(f)).length;
            } else f -= i;
            for (; f--; l += "0");
            p.c.push(+l);
          }
      ...
      (y.clone = j),
              ...
              if (typeof w == "object") {
                if (
                  (w.hasOwnProperty((x = "DECIMAL_PLACES")) &&
                    ((_ = w[x]), ot(_, 0, k, x), (ht = _)),
                  w.hasOwnProperty((x = "ROUNDING_MODE")) &&
                    ((_ = w[x]), ot(_, 0, 8, x), (ft = _)),
                  ...
                  if (((_ = w[x]), _ && _.pop))
                    ot(_[0], -k, -1, x),
                      ...
                      (Pt = _[0]),
                      (Ft = _[1]);
                  else if ((ot(_, -k, k, x), _)) Pt = -(Ft = _ < 0 ? -_ : _);
        ...
        (y.isBigNumber = function (w) {
          ...
          t: if ({}.toString.call(T) == "[object Array]") {
            if ((U === 1 || U === -1) && S >= -k && S <= k && S === d(S)) {
              if (T[0] === 0) {
                if (S === 0 && T.length === 1) return !0;
                break t;
              }
              if (
                ((x = (S + 1) % B), x < 1 && (x += B), String(T[0]).length == x)
              ) {
        ...
        (y.random = (function () {
          ...
          return function (_) {
            var T,
              ...
              l = [],
              p = new y(yt);
            if ((_ == null ? (_ = ht) : ot(_, 0, k), (f = u(_ / B)), G))
                ...
                for (T = crypto.randomBytes((f *= 7)); i < f; )
                  (n =
                    ...
                    n >= 9e15
                      ...
                      : (l.push(n % 1e14), (i += 7));
                i = f / 7;
              } else throw ((G = !1), Error(g + "crypto unavailable"));
            if (!G) for (; i < f; ) (n = x()), n < 9e15 && (l[i++] = n % 1e14);
            for (
              f = l[--i],
                _ %= B,
                f && _ && ((n = L[B - _]), (l[i] = d(f / n) * n));
              l[i] === 0;
              l.pop(), i--
            );
            if (i < 0) l = [(U = 0)];
            else {
              for (U = -1; l[0] === 0; l.splice(0, 1), U -= B);
          ...
          return function (_, T, S, U, f) {
            ...
            for (
              V >= 0 &&
                ...
                (F = z.pow(_.length - V)),
                (q = p),
                (z.c = x(Y(rt(F.c), F.e, "0"), 10, S, w)),
                (z.e = z.c.length)),
                O = x(_, T, S, f ? ((n = H), w) : ((n = w), H)),
                l = p = O.length;
              O[--p] == 0;
              O.pop()
            );
            ...
            if (
              ...
              _ = E ? Y(n.charAt(1), -et, n.charAt(0)) : n.charAt(0);
            else {
              if (((O.length = i), E))
                for (--S; ++O[--i] > S; )
                  (O[i] = 0), i || (++l, (O = [1].concat(O)));
              for (p = O.length; !O[--p]; );
              for (V = 0, _ = ""; V <= p; _ += n.charAt(O[V++]));
              _ = Y(_, l, n.charAt(0));
            }
            return _;
          };
          ...
          return function (T, S, U, f, n) {
            ...
            for (
              V = new y(lt),
                ...
                lt = U + l + 1,
                n ||
                  ((n = b), (l = X(T.e / B) - X(S.e / B)), (lt = (lt / B) | 0)),
                p = 0;
              Z[p] == (it[p] || 0);
              p++
            );
            if ((Z[p] > (it[p] || 0) && l--, lt < 0)) et.push(1), (E = !0);
            else {
              for (
                A = it.length,
                  v = Z.length,
                ...
                if (((F = 0), (i = x(Z, h, v, s)), i < 0)) {
                  if (
                    ...
                    for (
                      ...
                      F--, _(O, v < z ? Q : Z, z, n), (z = O.length), (i = 1);
                  else F == 0 && (i = F = 1), (O = Z.slice()), (z = O.length);
                  if (
                    (z < s && (O = [0].concat(O)),
                    _(h, O, s, n),
                    (s = h.length),
                    ...
                    for (; x(Z, h, v, s) < 1; )
                      F++, _(h, v < s ? Q : Z, s, n), (s = h.length);
                } else i === 0 && (F++, (h = [0]));
                (et[p++] = F),
                  h[0] ? (h[s++] = it[m] || 0) : ((h = [it[m]]), (s = 1));
              } while ((m++ < A || h[0] != null) && lt--);
              (E = h[0] != null), et[0] || et.splice(0, 1);
            }
            if (n == b) {
              for (p = 1, lt = et[0]; lt >= 10; lt /= 10, p++);
              $(V, U + (V.e = p + l * B - 1) + 1, f, E);
            } else (V.e = l), (V.r = +E);
            return V;
          };
        })());
      function dt(w, x, _, T) {
        var S, U, f, n, i;
        if ((_ == null ? (_ = ft) : ot(_, 0, 8), !w.c)) return w.toString();
      ...
      function ut(w, x) {
        for (var _, T, S = 1, U = new y(w[0]); S < w.length; S++)
          (T = new y(w[S])),
            (!T.s || (_ = mt(U, T)) === x || (_ === 0 && U.s === x)) && (U = T);
        return U;
      }
      function gt(w, x, _) {
      ...
      at = (function () {
        ...
        return function (U, f, n, i) {
          ...
          if (T.test(p)) U.s = isNaN(p) ? null : p < 0 ? -1 : 1;
            ...
            if (
              !n &&
              ((p = p.replace(w, function (E, F, O) {
                return (
                  (l = (O = O.toLowerCase()) == "x" ? 16 : O == "b" ? 2 : 8),
                  !i || i == l ? F : E
                );
              })),
      ...
      function $(w, x, _, T) {
        ...
        if (E) {
          t: {
            ...
            if (((U = x - S), U < 0))
              (U += B),
                ...
                (i = E[(l = 0)]),
                (p = d((i / F[S - f - 1]) % 10));
            else if (((l = u((U + 1) / B)), l >= E.length))
              if (T) {
                for (; E.length <= l; E.push(0));
                (i = p = 0), (S = 1), (U %= B), (f = U - B + 1);
              } else break t;
            else {
          ...
          w.e > Ft ? (w.c = w.e = null) : w.e < Pt && (w.c = [(w.e = 0)]);
        }
        return w;
      }
      function K(w) {
      ...
      return (
        ...
        (M.decimalPlaces = M.dp =
          function (w, x) {
            ...
            if (w != null)
              return (
                ot(w, 0, k),
                x == null ? (x = ft) : ot(x, 0, 8),
                $(new y(U), w + U.e + 1, x)
              );
            if (!(_ = U.c)) return null;
            if (((T = ((S = _.length - 1) - X(this.e / B)) * B), (S = _[S])))
              for (; S % 10 == 0; S /= 10, T--);
            return T < 0 && (T = 0), T;
          }),
        (M.dividedBy = M.div =
          function (w, x) {
            return J(this, new y(w, x), ht, ft);
          }),
        ...
        (M.exponentiatedBy = M.pow =
          function (w, x) {
            ...
            if (((w = new y(w)), w.c && !w.isInteger()))
              throw Error(g + "Exponent not an integer: " + K(w));
            if (
              (x != null && (x = new y(x)),
              (n = w.e > 14),
              !E.c ||
              ...
              return (
                (p = new y(Math.pow(+K(E), n ? w.s * (2 - nt(w)) : +K(w)))),
                x ? p.mod(x) : p
              );
            if (((i = w.s < 0), x)) {
            ...
            for (
              n
                ? ((_ = new y(0.5)), i && (w.s = 1), (l = nt(w)))
                : ((S = Math.abs(+K(w))), (l = S % 2)),
                p = new y(yt);
              ;
              ...
              if (S) {
                ...
                l = S % 2;
              } else if (((w = w.times(_)), $(w, w.e + 1, 1), w.e > 14))
                l = nt(w);
              else {
                if (((S = +K(w)), S === 0)) break;
                l = S % 2;
            ...
            return T
              ? p
              : (i && (p = yt.div(p)), x ? p.mod(x) : U ? $(p, q, ft, f) : p);
          }),
        (M.integerValue = function (w) {
          var x = new y(this);
          return w == null ? (w = ft) : ot(w, 0, 8), $(x, x.e + 1, w);
        }),
        (M.isEqualTo = M.eq =
          function (w, x) {
        ...
        (M.isInteger = function () {
          return !!this.c && X(this.e / B) > this.c.length - 2;
        }),
        (M.isLessThan = M.lt =
          function (w, x) {
            return mt(this, new y(w, x)) < 0;
        ...
        (M.minus = function (w, x) {
          ...
          if (((i = X(i)), (l = X(l)), (p = p.slice()), (n = i - l))) {
            for (
              (U = n < 0) ? ((n = -n), (S = p)) : ((l = i), (S = E)),
                S.reverse(),
                x = n;
              x--;
              S.push(0)
          ...
          function (w, x) {
            ...
            for (
              T = X(h.e / B) + X(w.e / B),
                ...
                i = s.length,
                E = a.length,
                i < E && ((z = s), (s = a), (a = z), (S = i), (i = E), (E = S)),
                S = i + E,
                z = [];
              S--;
              z.push(0)
            );
            for (V = b, et = D, S = E; --S >= 0; ) {
              for (
                _ = 0, F = a[S] % et, O = (a[S] / et) | 0, f = i, U = S + f;
                U > S;
            ...
            return _ ? ++T : z.splice(0, 1), gt(w, z, T);
          }),
        (M.negated = function () {
          var w = new y(this);
        ...
        (M.plus = function (w, x) {
          ...
          if (((U = X(U)), (f = X(f)), (n = n.slice()), (S = U - f))) {
            for (
              S > 0 ? ((f = U), (_ = i)) : ((S = -S), (_ = n)), _.reverse();
              S--;
              _.push(0)
            );
            _.reverse();
          ...
          for (
            ...
            (S = ((n[--x] = n[x] + i[x] + S) / b) | 0),
              (n[x] = b === n[x] ? 0 : n[x] % b);
          return S && ((n = [S].concat(n)), ++f), gt(w, n, f);
        }),
        (M.precision = M.sd =
          function (w, x) {
            var _,
            ...
            if (!(_ = U.c)) return null;
            if (((S = _.length - 1), (T = S * B + 1), (S = _[S]))) {
              for (; S % 10 == 0; S /= 10, T--);
              for (S = _[0]; S >= 10; S /= 10, T++);
            }
            return w && U.e + 1 > T && (T = U.e + 1), T;
          }),
        (M.shiftedBy = function (w) {
          return ot(w, -N, N), this.times("1e" + w);
        }),
        (M.squareRoot = M.sqrt =
          function () {
            var w,
            ...
            if (
              ...
              for (i = _.e, n = i + l, n < 3 && (n = 0); ; )
                if (
                  ((S = _),
                  (_ = p.times(S.plus(J(U, S, l, 1)))),
                  rt(S.c).slice(0, n) === (x = rt(_.c)).slice(0, n))
                )
                  if (
                    (_.e < i && --n,
                    (x = x.slice(n - 3, n + 1)),
                    ...
                    if (!T && ($(S, S.e + ht + 2, 0), S.times(S).eq(U))) {
                      _ = S;
                      break;
                    }
                    (l += 4), (n += 4), (T = 1);
                    ...
                    (!+x || (!+x.slice(1) && x.charAt(0) == "5")) &&
                      ($(_, _.e + ht + 2, 1), (w = !_.times(_).eq(U)));
                    break;
                  }
            }
            return $(_, _.e + ht + 1, ft, w);
          }),
        (M.toExponential = function (w, x) {
          return w != null && (ot(w, 0, k), w++), dt(this, w, x, 1);
        }),
        (M.toFixed = function (w, x) {
          return (
            w != null && (ot(w, 0, k), (w = w + this.e + 1)), dt(this, w, x)
          );
        }),
        (M.toFormat = function (w, x, _) {
          var T,
            S = this;
          if (_ == null)
          ...
          if (((T = S.toFixed(w, x)), S.c)) {
            ...
            if ((i && ((U = n), (n = i), (i = U), (z -= U)), n > 0 && z > 0)) {
              for (U = z % n || n, p = O.substr(0, U); U < z; U += n)
                p += l + O.substr(U, n);
              i > 0 && (p += l + O.slice(U)), F && (p = "-" + p);
            }
            T = E
              ? p +
                (_.decimalSeparator || "") +
        ...
        (M.toFraction = function (w) {
          ...
          if (
            w != null &&
            ((n = new y(w)), (!n.isInteger() && (n.c || n.s !== 1)) || n.lt(yt))
          )
            throw Error(
              g +
                "Argument " +
          ...
          for (
            x = new y(yt),
              ...
              T = i = new y(yt),
              F = rt(z),
              U = x.e = F.length - O.e - 1,
              x.c[0] = L[(f = U % B) < 0 ? B + f : f],
          ...
          return (
            ...
            (E =
              J(l, T, U, ft)
                .minus(O)
                .abs()
                .comparedTo(J(i, _, U, ft).minus(O).abs()) < 1
                ? [l, T]
                : [i, _]),
            (Ft = f),
            E
        ...
        (M.toPrecision = function (w, x) {
          return w != null && ot(w, 1, k), dt(this, w, x, 2);
        }),
        (M.toString = function (w) {
          var x,
            _ = this,
            T = _.s,
            S = _.e;
          return (
            S === null
              ...
              : (w == null
                  ? (x =
                      S <= At || S >= bt ? St(rt(_.c), S) : Y(rt(_.c), S, "0"))
                  : w === 10 && st
                    ? ((_ = $(new y(_), ht + S + 1, ft)),
                      (x = Y(rt(_.c), _.e, "0")))
                    : (ot(w, 2, H.length, "Base"),
                      (x = tt(Y(rt(_.c), S, "0"), 10, w, T, !0))),
                T < 0 && _.c[0] && (x = "-" + x)),
            x
          );
        }),
    ...
    function rt(W) {
      for (var J, tt, at = 1, M = W.length, yt = W[0] + ""; at < M; ) {
        for (J = W[at++] + "", tt = B - J.length; tt--; J = "0" + J);
        yt += J;
      }
      for (M = yt.length; yt.charCodeAt(--M) === 48; );
      return yt.slice(0, M + 1 || 1);
    }
    function mt(W, J) {
      var tt,
        at,
      ...
      if (((tt = M && !M[0]), (at = yt && !yt[0]), tt || at))
        return tt ? (at ? 0 : -ft) : ht;
      if (ht != ft) return ht;
      if (((tt = ht < 0), (at = At == bt), !M || !yt))
        return at ? 0 : !M ^ tt ? 1 : -1;
      if (!at) return (At > bt) ^ tt ? 1 : -1;
      for (
        ft = (At = M.length) < (bt = yt.length) ? At : bt, ht = 0;
        ht < ft;
        ht++
      )
        if (M[ht] != yt[ht]) return (M[ht] > yt[ht]) ^ tt ? 1 : -1;
      return At == bt ? 0 : (At > bt) ^ tt ? 1 : -1;
    }
    function ot(W, J, tt, at) {
      if (W < J || W > tt || W !== d(W))
        throw Error(
          g +
            (at || "Argument") +
    ...
    function Y(W, J, tt) {
      ...
      if (J < 0) {
        for (M = tt + "."; ++J; M += tt);
        W = M + W;
      } else if (((at = W.length), ++J > at)) {
        for (M = tt, J -= at; --J; M += tt);
        W += M;
      } else J < at && (W = W.slice(0, J) + "." + W.slice(J));
      return W;
    }
    (r = j()),
...
var rr = ti.exports,
  Ks = function (t, r, o) {
    var u = new t.Uint8Array(o),
      ...
      rt = r.pushNull,
      mt = r.pushInfinity,
      ot = r.pushInfinityNeg,
      nt = r.pushNaN,
      St = r.pushNaNNeg,
      Y = r.pushArrayStart,
      W = r.pushArrayStartFixed,
      J = r.pushArrayStartFixed32,
      tt = r.pushArrayStartFixed64,
      at = r.pushObjectStart,
      M = r.pushObjectStartFixed,
      yt = r.pushObjectStartFixed32,
      ht = r.pushObjectStartFixed64,
      ft = r.pushByteString,
      At = r.pushByteStringStart,
      bt = r.pushUtf8String,
      Pt = r.pushUtf8StringStart,
      Ft = r.pushSimpleUnassigned,
      G = r.pushTagStart,
      P = r.pushTagStart4,
      q = r.pushTagStart8,
      C = r.pushTagUnassigned,
      H = r.pushBreak,
      st = t.Math.pow,
      y = 0,
      dt = 0,
    ...
    function _(I) {
      return (
        (I = I | 0),
        $(1) | 0 ? 1 : (d(u[(y + 1) | 0] | 0), (y = (y + 2) | 0), 0)
      );
    }
    function T(I) {
      return (
        (I = I | 0),
        $(2) | 0 ? 1 : (d(K((y + 1) | 0) | 0), (y = (y + 3) | 0), 0)
      );
    }
    function S(I) {
      return (
        ...
        $(4) | 0
          ? 1
          : (g(K((y + 1) | 0) | 0, K((y + 3) | 0) | 0), (y = (y + 5) | 0), 0)
      );
    }
    function U(I) {
      return (
    ...
    function l(I) {
      return (
        ...
        $(4) | 0
          ? 1
          : (c(K((y + 1) | 0) | 0, K((y + 3) | 0) | 0), (y = (y + 5) | 0), 0)
      );
    }
    function p(I) {
      return (
    ...
    function R(I) {
      return (I = I | 0), Pt(), (y = (y + 1) | 0), 0;
    }
    function v(I) {
      return (I = I | 0), W((I - 128) | 0), (y = (y + 1) | 0), 0;
    }
    function Q(I) {
      return (
        (I = I | 0),
        $(1) | 0 ? 1 : (W(u[(y + 1) | 0] | 0), (y = (y + 2) | 0), 0)
      );
    }
    function lt(I) {
      return (
        (I = I | 0),
        $(2) | 0 ? 1 : (W(K((y + 1) | 0) | 0), (y = (y + 3) | 0), 0)
      );
    }
    function it(I) {
      return (
        ...
        $(4) | 0
          ? 1
          : (J(K((y + 1) | 0) | 0, K((y + 3) | 0) | 0), (y = (y + 5) | 0), 0)
      );
    }
    function Z(I) {
      return (
    ...
    function Tt(I) {
      ...
      return (
        (wt = (I - 160) | 0),
        $(wt | 0) | 0 ? 1 : (M(wt | 0), (y = (y + 1) | 0), 0)
      );
    }
    function Hi(I) {
      return (
        (I = I | 0),
        $(1) | 0 ? 1 : (M(u[(y + 1) | 0] | 0), (y = (y + 2) | 0), 0)
      );
    }
    function Ki(I) {
      return (
        (I = I | 0),
        $(2) | 0 ? 1 : (M(K((y + 1) | 0) | 0), (y = (y + 3) | 0), 0)
      );
    }
    function zi(I) {
      return (
        ...
        $(4) | 0
          ? 1
          : (yt(K((y + 1) | 0) | 0, K((y + 3) | 0) | 0), (y = (y + 5) | 0), 0)
      );
    }
    function Yi(I) {
      return (
    ...
    function pe(I) {
      return (I = I | 0), G((I - 192) | 0 | 0), (y = (y + 1) | 0), 0;
    }
    function D0(I) {
      return (I = I | 0), G(I | 0), (y = (y + 1) | 0), 0;
    }
    function P0(I) {
      return (I = I | 0), G(I | 0), (y = (y + 1) | 0), 0;
    }
    ...
    function qi(I) {
      return (
        (I = I | 0),
        $(1) | 0 ? 1 : (G(u[(y + 1) | 0] | 0), (y = (y + 2) | 0), 0)
      );
    }
    function Vi(I) {
      return (
        (I = I | 0),
        $(2) | 0 ? 1 : (G(K((y + 1) | 0) | 0), (y = (y + 3) | 0), 0)
      );
    }
    function Ji(I) {
      return (
        ...
        $(4) | 0
          ? 1
          : (P(K((y + 1) | 0) | 0, K((y + 3) | 0) | 0), (y = (y + 5) | 0), 0)
      );
    }
    function Xi(I) {
      return (
    ...
    function Nt(I) {
      return (I = I | 0), Ft(((I | 0) - 224) | 0), (y = (y + 1) | 0), 0;
    }
    function ji(I) {
      return (I = I | 0), j(), (y = (y + 1) | 0), 0;
    }
    function Zi(I) {
      return (I = I | 0), k(), (y = (y + 1) | 0), 0;
    }
    function Qi(I) {
      return (I = I | 0), rt(), (y = (y + 1) | 0), 0;
    }
    function ts(I) {
...
Dt.SIMPLE = { FALSE: 20, TRUE: 21, NULL: 22, UNDEFINED: 23 };
Dt.SYMS = {
  NULL: Symbol("null"),
...
Dt.SHIFT32 = Math.pow(2, 32);
Dt.SHIFT16 = Math.pow(2, 16);
Dt.MAX_SAFE_HIGH = 2097151;
Dt.NEG_ONE = new kr(-1);
Dt.TEN = new kr(10);
Dt.TWO = new kr(2);
Dt.PARENT = {
...
(function (e) {
  ...
  e.parseHalf = function (B) {
    ...
    return (
      ...
      N
        ? N === 31
          ? D * (L ? NaN : 1 / 0)
          : D * Math.pow(2, N - 25) * (1024 + L)
        : D * 5960464477539063e-23 * L
    );
  };
  function c(b) {
  ...
  (e.arrayBufferToBignumber = function (b) {
    const B = b.byteLength;
    let N = "";
    for (let L = 0; L < B; L++) N += c(b[L]);
    return new r(N, 16);
  }),
    (e.buildMap = (b) => {
      const B = new Map(),
        N = Object.keys(b),
        L = N.length;
      for (let D = 0; D < L; D++) B.set(N[D], b[N[D]]);
      return B;
    }),
    (e.buildInt32 = (b, B) => b * d + B),
    (e.buildInt64 = (b, B, N, L) => {
      const D = e.buildInt32(b, B),
        k = e.buildInt32(N, L);
      return D > g ? new r(D).times(u).plus(k) : D * u + k;
    }),
    (e.writeHalf = function (B, N) {
      const L = t.allocUnsafe(4);
      L.writeFloatBE(N, 0);
      const D = L.readUInt32BE(0);
      if (D & 8191) return !1;
      var k = (D >> 16) & 32768;
      const j = (D >> 23) & 255,
        X = D & 8388607;
      if (j >= 113 && j <= 142) k += ((j - 112) << 10) + (X >> 13);
      else if (j >= 103 && j < 113) {
        if (X & ((1 << (126 - j)) - 1)) return !1;
        k += (X + 8388608) >> (126 - j);
      } else return !1;
      return B.writeUInt16BE(k, 0), !0;
    }),
    (e.keySorter = function (b, B) {
      var N = b[0].byteLength,
        L = B[0].byteLength;
      return N > L ? 1 : L > N ? -1 : b[0].compare(B[0]);
    }),
...
let Ys = class _r {
  ...
  encodeCBOR(t) {
    return t._pushInt(this.value, zs.SIMPLE_FLOAT);
  }
  static isSimple(t) {
...
let Ws = class Ir {
  ...
  convert(t) {
    ...
    if (
      ((o = t?.[this.tag]),
      typeof o != "function" &&
        ((o = Ir["_tag" + this.tag]), typeof o != "function"))
    )
      return this;
    try {
      return o.call(Ir, this.value);
    } catch (u) {
...
var ri = Ws;
const ni = self.location
    ? self.location.protocol + "//" + self.location.host
    : "",
  Br = self.URL;
let qs = class {
  constructor(t = "", r = ni) {
    (this.super = new Br(t, r)),
...
function Vs(e) {
  if (typeof e == "string") return new Br(e).toString();
  if (!(e instanceof Br)) {
    const t = e.username && e.password ? `${e.username}:${e.password}@` : "",
      ...
      B = e.pathname || "",
      N = e.path || B + c;
    return `${u}${t || r}${d || g + o}${N}${b}`;
  }
}
var ii = {
  URLWithLegacySupport: qs,
  URLSearchParams: self.URLSearchParams,
  defaultBase: ni,
  format: Vs,
};
const { URLWithLegacySupport: ln, format: Js } = ii;
var Xs = (e, t = {}, r = {}, o) => {
...
let Ar = class Sr {
      ...
      (this._knownTags = Object.assign(
        {
          ...
          3: (r) => _t.NEG_ONE.minus(Mt.arrayBufferToBignumber(r)),
          4: (r) => _t.TEN.pow(r[0]).times(r[1]),
          5: (r) => _t.TWO.pow(r[0]).times(r[1]),
          32: (r) => new oo(r),
          35: (r) => new RegExp(r),
        },
        t.tags,
  ...
  _closeParent() {
    ...
    switch (t.type) {
      case _t.PARENT.TAG:
        ...
        break;
      case _t.PARENT.BYTE_STRING:
        this._push(this.createByteString(t.ref, t.length));
        break;
      case _t.PARENT.UTF8_STRING:
        ...
        o.tmpKey != null
          ...
          : ((o.tmpKey = t),
            typeof o.tmpKey != "string" &&
              ((o.type = _t.PARENT.MAP), (o.ref = Mt.buildMap(o.ref))));
        break;
      case _t.PARENT.MAP:
        o.tmpKey != null
  ...
  createFloatSingle(t, r, o, u) {
    return dn.read([t, r, o, u], 0, !1, 23, 4);
  }
  createFloatDouble(t, r, o, u, d, g, c, b) {
    return dn.read([t, r, o, u, d, g, c, b], 0, !1, 52, 8);
  }
  createInt32Neg(t, r) {
  ...
  createInt64Neg(t, r, o, u) {
    const d = Mt.buildInt32(t, r),
      g = Mt.buildInt32(o, u);
    return d > _t.MAX_SAFE_HIGH
      ? _t.NEG_ONE.minus(new ro(d).times(_t.SHIFT32).plus(g))
      : -1 - (d * _t.SHIFT32 + g);
  }
  createTrue() {
    return !0;
  ...
  pushArrayStart() {
    this._createParent([], _t.PARENT.ARRAY, -1);
  }
  ...
  pushTagStart(t) {
    this._parents[this._depth] = { type: _t.PARENT.TAG, length: 1, ref: [t] };
  }
  pushTagStart4(t, r) {
  ...
  _createObjectStartFixed(t) {
    ...
    this._createParent({}, _t.PARENT.OBJECT, t);
  }
  _createArrayStartFixed(t) {
    ...
    this._createParent(new Array(t), _t.PARENT.ARRAY, t);
  }
  _decode(t) {
  ...
  static decode(t, r) {
    return (
      ...
      new Sr({ size: t.length }).decodeFirst(t)
    );
  }
  static decodeAll(t, r) {
    return (
      typeof t == "string" && (t = ye.from(t, r || "hex")),
      new Sr({ size: t.length }).decodeAll(t)
    );
  }
};
Ar.decodeFirst = Ar.decode;
var oi = Ar;
const { Buffer: fr } = Le,
  ao = oi,
  uo = nr;
class Hr extends ao {
  ...
  createFloat(t) {
    ...
    return uo.isNegativeZero(t) ? "-0_1" : `${r}_1`;
  }
  createFloatSingle(t, r, o, u) {
  ...
  createMap(t, r) {
    const o = super.createMap(t),
      u = Array.from(o.keys()).reduce(pn(o), "");
    return r === -1 ? `{_ ${u}}` : `{${u}}`;
  }
  createObject(t, r) {
    const o = super.createObject(t),
      u = Object.keys(o).reduce(pn(o), "");
    return r === -1 ? `{_ ${u}}` : `{${u}}`;
  }
  createUtf8String(t, r) {
    const o = t.join(", ");
...
const { Buffer: qt } = Le,
  ...
  yn = Rt.SYMS,
  ge = Rt.TAG,
  ho = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.TWO,
  lo = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.FOUR,
  po = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.NUMBYTES.EIGHT,
  wo = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.TRUE,
  yo = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.FALSE,
  go = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.UNDEFINED,
  gn = (Rt.MT.SIMPLE_FLOAT << 5) | Rt.SIMPLE.NULL,
  xo = new Tr("0x20000000000000"),
  mo = qt.from("f97e00", "hex"),
  bo = qt.from("f9fc00", "hex"),
  Eo = qt.from("f97c00", "hex");
function _o(e) {
...
class Je {
  ...
  _pushFloat(t) {
    ...
    if (hr.writeHalf(r, t) && hr.parseHalf(r) === t)
      return this._pushUInt8(ho) && this.push(r);
    const o = qt.allocUnsafe(4);
    return (
      o.writeFloatBE(t, 0),
      o.readFloatBE(0) === t
        ? this._pushUInt8(lo) && this.push(o)
        : this._pushUInt8(po) && this._pushDoubleBE(t)
    );
  }
  _pushInt(t, r, o) {
    const u = r << 5;
    return t < 24
      ? this._pushUInt8(u | t)
      : t <= 255
        ? this._pushUInt8(u | Ce.ONE) && this._pushUInt8(t)
        : t <= 65535
          ? this._pushUInt8(u | Ce.TWO) && this._pushUInt16BE(t)
          : t <= 4294967295
            ? this._pushUInt8(u | Ce.FOUR) && this._pushUInt32BE(t)
            : t <= Number.MAX_SAFE_INTEGER
              ? this._pushUInt8(u | Ce.EIGHT) &&
                this._pushUInt32BE(Math.floor(t / wn)) &&
                this._pushUInt32BE(t % wn)
              : r === Gt.NEG_INT
                ? this._pushFloat(o)
                : this._pushFloat(t);
  }
  ...
  _pushString(t) {
    const r = qt.byteLength(t, "utf8");
    return this._pushInt(r, Gt.UTF8_STRING) && this.pushWrite(t, 5, r);
  }
  _pushBoolean(t) {
    return this._pushUInt8(t ? wo : yo);
  }
  _pushUndefined(t) {
    return this._pushUInt8(go);
  }
  _pushArray(t, r) {
    const o = r.length;
  ...
  _pushBigNumber(t, r) {
    ...
    const o = r.decimalPlaces(),
      u = r.multipliedBy(new Tr(10).pow(o));
  ...
  _pushObject(t) {
    if (!t) return this._pushUInt8(gn);
  ...
  pushAny(t) {
    ...
    switch (r) {
      ...
      case "Uint8Array":
        return this._pushBuffer(this, qt.isBuffer(t) ? t : qt.from(t));
      case "Null":
        return this._pushUInt8(gn);
      case "Undefined":
...
const Bo = new RegExp(/^[0-9a-fA-F]+$/);
function fe(e) {
  if (!Bo.test(e)) throw new Error("Invalid hexadecimal string.");
  const t = [...e]
...
function le(e) {
  return Te(Rs.create().update(new Uint8Array(e)).digest());
}
function Ge(e) {
  if (e instanceof ai.Tagged) return Ge(e.value);
  if (typeof e == "string") return hi(e);
  if (typeof e == "number") return le(fn(e));
  if (e instanceof ArrayBuffer || ArrayBuffer.isView(e)) return le(e);
  if (Array.isArray(e)) {
    const t = e.map(Ge);
    return le(Ue(...t));
  } else {
    if (e && typeof e == "object" && e._isPrincipal)
      return le(e.toUint8Array());
    if (typeof e == "object" && e !== null && typeof e.toHash == "function")
      return Ge(e.toHash());
    if (typeof e == "object") return li(e);
    if (typeof e == "bigint") return le(fn(e));
  }
  throw Object.assign(
...
const So = new TextEncoder().encode(`
ic-request`);
class zr {
  getPrincipal() {
    return (
      this._principal ||
        (this._principal = ce.selfAuthenticating(
  ...
  async transformRequest(t) {
    ...
    return Object.assign(Object.assign({}, o), {
      body: {
        ...
        sender_sig: await this.sign(Ue(So, u)),
      },
    });
  }
}
...
function di(e) {
  ...
  return Qt(new Uint8Array(ir(3, e.length)), new Uint8Array(t));
}
function Uo(e, t) {
...
function Wr(e, t) {
  ...
  if (((e = parseInt("" + e, t)), isNaN(e)))
    throw new RangeError("Invalid number.");
  return (e = Math.min(Math.max(0, e), To)), (e = e.toString(16)), zt(0, 27, e);
}
Bt.u64 = Wr;
function gi(e) {
  if (isNaN(e)) throw new RangeError("Invalid number.");
...
function Lo(e, t = !1) {
  ...
  return (
    ...
    Qt(ir(5, e.size), ...r.map(([o, u]) => Qt(di(o), u)))
  );
}
Bt.map = Lo;
function Oo(e) {
...
Bt.bool = Po;
function _i() {
  return Oe(new Uint8Array([245]));
}
Bt.true_ = _i;
function Ii() {
  return Oe(new Uint8Array([244]));
}
Bt.false_ = Ii;
function Mo() {
  return Oe(new Uint8Array([246]));
}
Bt.null_ = Mo;
function Co() {
  return Oe(new Uint8Array([247]));
}
Bt.undefined_ = Co;
var $o =
  (Ee && Ee.__importStar) ||
  ...
  encode(t) {
    switch (typeof t) {
      ...
      case "object":
        ...
        if (ko.find((r) => t instanceof r)) return Kt.bytes(t.buffer);
...
class Si {
  ...
  static withDefaultEncoders(t = !1) {
    const r = new this();
    return r.addEncoder(new Bi(r, t)), r.addEncoder(new Ai()), r;
  }
  removeEncoder(t) {
...
Ie.SelfDescribeCborSerializer = Go;
(function (e) {
  function t(u) {
...
class zo {
  ...
  encode(t) {
    return t > BigInt(0)
      ? $t.value.tagged(2, $t.value.bytes(fe(t.toString(16))))
      : $t.value.tagged(3, $t.value.bytes(fe((BigInt("-1") * t).toString(16))));
  }
}
const qr = $t.SelfDescribeCborSerializer.withDefaultEncoders(!0);
qr.addEncoder(new Ho());
qr.addEncoder(new Ko());
qr.addEncoder(new zo());
var mn;
(function (e) {
  (e[(e.Uint64LittleEndian = 71)] = "Uint64LittleEndian"),
    (e[(e.Semantic = 55799)] = "Semantic");
})(mn || (mn = {}));
class Y0 extends ai.Decoder {
  createByteString(t) {
    return Ue(...t);
  }
  createByteStringFromHeap(t, r) {
...
function Jr(e) {
  if (!Vr(e)) throw new Error("Uint8Array expected");
}
...
function Ui(e) {
  ...
  for (let u = 0, d = 0; u < r; u++, d += 2) {
    const g = En(e.charCodeAt(d)),
      c = En(e.charCodeAt(d + 1));
...
function He(e) {
  return Jr(e), Ti(Xr(Uint8Array.from(e).reverse()));
}
function Ni(e, t) {
  return Ui(e.toString(16).padStart(t * 2, "0"));
}
function Ur(e, t) {
  return Ni(e, t).reverse();
}
function re(e, t, r) {
  let o;
  if (typeof t == "string")
  ...
  else if (Vr(t)) o = Uint8Array.from(t);
...
function Zo(e, t, r) {
  if (r <= Ot || t < Ot) throw new Error("Expected power/modulo > 0");
  if (r === Ut) return Ot;
  let o = Ut;
  for (; t > Ot; ) t & Ut && (o = (o * e) % r), (e = (e * e) % r), (t >>= Ut);
  return o;
}
function Wt(e, t, r) {
  let o = e;
...
function An(e, t) {
  ...
  if (o !== Ut) throw new Error("invert: does not exist");
  return vt(u, t);
}
function Qo(e) {
  const t = (e - Ut) / de;
  let r, o, u;
  for (r = e - Ut, o = 0; r % de === Ot; r /= de, o++);
  for (u = de; u < e && Zo(u, t, e) !== e - Ut; u++);
  if (o === 1) {
    const g = (e + Ut) / Nr;
    return function (b, B) {
      const N = b.pow(B, g);
      if (!b.eql(b.sqr(N), B)) throw new Error("Cannot find square root");
      return N;
    };
  }
  const d = (r + Ut) / de;
  return function (c, b) {
    ...
    for (; !c.eql(D, c.ONE); ) {
      ...
      let k = 1;
      for (let X = c.sqr(D); k < B && !c.eql(X, c.ONE); k++) X = c.sqr(X);
      const j = c.pow(N, Ut << BigInt(B - k - 1));
      (N = c.sqr(j)), (L = c.mul(L, j)), (D = c.mul(D, N)), (B = k);
    }
    return L;
  };
}
  ...
  if (e % Bn === In) {
    ...
    return function (o, u) {
      const d = o.mul(u, de),
        g = o.pow(d, t),
        c = o.mul(u, g),
        b = o.mul(o.mul(c, de), g),
        B = o.mul(c, o.sub(b, o.ONE));
      if (!o.eql(o.sqr(B), u)) throw new Error("Cannot find square root");
      return B;
    };
  }
  return Qo(e);
}
const ea = (e, t) => (vt(e, t) & Ut) === Ut,
  ra = [
    "create",
    "isValid",
    "is0",
...
function na(e) {
  const t = {
    ...
    r = ra.reduce((o, u) => ((o[u] = "function"), o), t);
  return jr(e, r);
}
function ia(e, t, r) {
  if (r < Ot) throw new Error("Expected power > 0");
  if (r === Ot) return e.ONE;
  if (r === Ut) return t;
  let o = e.ONE,
    u = t;
  for (; r > Ot; ) r & Ut && (o = e.mul(o, u)), (u = e.sqr(u)), (r >>= Ut);
  return o;
}
function sa(e, t) {
...
function oa(e, t, r = !1, o = {}) {
  if (e <= Ot) throw new Error(`Expected Field ORDER > 0, got ${e}`);
  const { nBitLength: u, nByteLength: d } = Fi(e, t);
  if (d > 2048)
  ...
  const g = ta(e),
    c = Object.freeze({
      ...
      inv: (b) => An(b, e),
      sqrt: o.sqrt || ((b) => g(c, b)),
      invertBatch: (b) => sa(c, b),
      cmov: (b, B, N) => (N ? B : b),
      toBytes: (b) => (r ? Ur(b, d) : Ni(b, d)),
      fromBytes: (b) => {
        if (b.length !== d)
...
/*! noble-curves - MIT License (c) 2022 Paul Miller (paulmillr.com) */ const ua =
    BigInt(0),
  lr = BigInt(1);
function ca(e, t) {
  const r = (u, d) => {
  ...
  return {
    ...
    unsafeLadder(u, d) {
      let g = e.ZERO,
        c = u;
      for (; d > ua; ) d & lr && (g = g.add(c)), (c = c.double()), (d >>= lr);
      return g;
    },
    precomputeWindow(u, d) {
      const { windows: g, windowSize: c } = o(d),
        b = [];
      let B = u,
        N = B;
      for (let L = 0; L < g; L++) {
        (N = B), b.push(N);
        for (let D = 1; D < c; D++) (N = N.add(B)), b.push(N);
        B = N.double();
      }
      return b;
    },
    wNAF(u, d, g) {
      const { windows: c, windowSize: b } = o(u);
      let B = e.ZERO,
        N = e.BASE;
      const L = BigInt(2 ** u - 1),
        D = 2 ** u,
        k = BigInt(u);
      for (let j = 0; j < c; j++) {
        const X = j * b;
        ...
        const mt = X,
          ...
          nt = j % 2 !== 0,
          St = rt < 0;
        rt === 0 ? (N = N.add(r(nt, d[mt]))) : (B = B.add(r(St, d[ot])));
      }
      return { p: B, f: N };
    },
    wNAFCached(u, d, g, c) {
      const b = u._WINDOW_SIZE || 1;
      let B = d.get(u);
      return (
        B || ((B = this.precomputeWindow(u, b)), b !== 1 && d.set(u, c(B))),
        this.wNAF(b, B, g)
      );
    },
  };
...
function fa(e) {
  return (
    ...
    Object.freeze({ ...Fi(e.n, e.nBitLength), ...e, p: e.Fp.ORDER })
  );
}
fe(
...
function vi(e, t = !1) {
  return t
    ? { h: Number(e & $e), l: Number((e >> Fr) & $e) }
    : { h: Number((e >> Fr) & $e) | 0, l: Number(e & $e) | 0 };
}
function ha(e, t = !1) {
  let r = new Uint32Array(e.length),
    o = new Uint32Array(e.length);
  for (let u = 0; u < e.length; u++) {
    const { h: d, l: g } = vi(e[u], t);
    [r[u], o[u]] = [d, g];
  }
  return [r, o];
}
const la = (e, t) => (BigInt(e >>> 0) << Fr) | BigInt(t >>> 0),
  da = (e, t, r) => e >>> r,
  pa = (e, t, r) => (e << (32 - r)) | (t >>> r),
  wa = (e, t, r) => (e >>> r) | (t << (32 - r)),
  ya = (e, t, r) => (e << (32 - r)) | (t >>> r),
  ga = (e, t, r) => (e << (64 - r)) | (t >>> (r - 32)),
  xa = (e, t, r) => (e >>> (r - 32)) | (t << (64 - r)),
  ma = (e, t) => t,
  ba = (e, t) => e,
  Ea = (e, t, r) => (e << r) | (t >>> (32 - r)),
  _a = (e, t, r) => (t << r) | (e >>> (32 - r)),
  Ia = (e, t, r) => (t << (r - 32)) | (e >>> (64 - r)),
  Ba = (e, t, r) => (e << (r - 32)) | (t >>> (64 - r));
function Aa(e, t, r, o) {
  const u = (t >>> 0) + (o >>> 0);
  return { h: (e + r + ((u / 2 ** 32) | 0)) | 0, l: u | 0 };
}
const Sa = (e, t, r) => (e >>> 0) + (t >>> 0) + (r >>> 0),
  Ta = (e, t, r, o) => (t + r + o + ((e / 2 ** 32) | 0)) | 0,
  Ua = (e, t, r, o) => (e >>> 0) + (t >>> 0) + (r >>> 0) + (o >>> 0),
  Na = (e, t, r, o, u) => (t + r + o + u + ((e / 2 ** 32) | 0)) | 0,
  Fa = (e, t, r, o, u) =>
    (e >>> 0) + (t >>> 0) + (r >>> 0) + (o >>> 0) + (u >>> 0),
  va = (e, t, r, o, u, d) => (t + r + o + u + d + ((e / 2 ** 32) | 0)) | 0,
  ct = {
    fromBig: vi,
    split: ha,
    toBig: la,
...
class Oa extends Wn {
  ...
  get() {
    ...
    return [t, r, o, u, d, g, c, b, B, N, L, D, k, j, X, rt];
  }
  set(t, r, o, u, d, g, c, b, B, N, L, D, k, j, X, rt) {
    (this.Ah = t | 0),
      (this.Al = r | 0),
      (this.Bh = o | 0),
      (this.Bl = u | 0),
  ...
  process(t, r) {
    for (let nt = 0; nt < 16; nt++, r += 4)
      (ne[nt] = t.getUint32(r)), (ie[nt] = t.getUint32((r += 4)));
    for (let nt = 16; nt < 80; nt++) {
      const St = ne[nt - 15] | 0,
        Y = ie[nt - 15] | 0,
        W = ct.rotrSH(St, Y, 1) ^ ct.rotrSH(St, Y, 8) ^ ct.shrSH(St, Y, 7),
        J = ct.rotrSL(St, Y, 1) ^ ct.rotrSL(St, Y, 8) ^ ct.shrSL(St, Y, 7),
        tt = ne[nt - 2] | 0,
        at = ie[nt - 2] | 0,
        M = ct.rotrSH(tt, at, 19) ^ ct.rotrBH(tt, at, 61) ^ ct.shrSH(tt, at, 6),
        yt =
          ct.rotrSL(tt, at, 19) ^ ct.rotrBL(tt, at, 61) ^ ct.shrSL(tt, at, 6),
        ht = ct.add4L(J, yt, ie[nt - 7], ie[nt - 16]),
        ft = ct.add4H(ht, W, M, ne[nt - 7], ne[nt - 16]);
      (ne[nt] = ft | 0), (ie[nt] = ht | 0);
    }
    let {
      Ah: o,
      Al: u,
    ...
    for (let nt = 0; nt < 80; nt++) {
      const St =
          ct.rotrSH(L, D, 14) ^ ct.rotrSH(L, D, 18) ^ ct.rotrBH(L, D, 41),
        Y = ct.rotrSL(L, D, 14) ^ ct.rotrSL(L, D, 18) ^ ct.rotrBL(L, D, 41),
        W = (L & k) ^ (~L & X),
        J = (D & j) ^ (~D & rt),
        tt = ct.add5L(ot, Y, J, La[nt], ie[nt]),
        at = ct.add5H(tt, mt, St, W, Ra[nt], ne[nt]),
        M = tt | 0,
        yt = ct.rotrSH(o, u, 28) ^ ct.rotrBH(o, u, 34) ^ ct.rotrBH(o, u, 39),
        ht = ct.rotrSL(o, u, 28) ^ ct.rotrBL(o, u, 34) ^ ct.rotrBL(o, u, 39),
        ft = (o & d) ^ (o & c) ^ (d & c),
        At = (u & g) ^ (u & b) ^ (g & b);
      (mt = X | 0),
        (ot = rt | 0),
        ...
        (k = L | 0),
        (j = D | 0),
        ({ h: L, l: D } = ct.add(B | 0, N | 0, at | 0, M | 0)),
        (B = c | 0),
        (N = b | 0),
        (c = d | 0),
        (b = g | 0),
        (d = o | 0),
        (g = u | 0);
      const bt = ct.add3L(M, ht, At);
      (o = ct.add3H(bt, at, yt, ft)), (u = bt | 0);
    }
    ({ h: o, l: u } = ct.add(this.Ah | 0, this.Al | 0, o | 0, u | 0)),
      ({ h: d, l: g } = ct.add(this.Bh | 0, this.Bl | 0, d | 0, g | 0)),
      ({ h: c, l: b } = ct.add(this.Ch | 0, this.Cl | 0, c | 0, b | 0)),
      ({ h: B, l: N } = ct.add(this.Dh | 0, this.Dl | 0, B | 0, N | 0)),
      ({ h: L, l: D } = ct.add(this.Eh | 0, this.El | 0, L | 0, D | 0)),
      ({ h: k, l: j } = ct.add(this.Fh | 0, this.Fl | 0, k | 0, j | 0)),
      ({ h: X, l: rt } = ct.add(this.Gh | 0, this.Gl | 0, X | 0, rt | 0)),
      ({ h: mt, l: ot } = ct.add(this.Hh | 0, this.Hl | 0, mt | 0, ot | 0)),
      this.set(o, u, d, g, c, b, B, N, L, D, k, j, X, rt, mt, ot);
  }
  roundClean() {
    ne.fill(0), ie.fill(0);
  }
...
function Zr(e) {
  const t = Ma(e),
    ...
    L =
      ...
      ((G, P) => {
        try {
          return { isValid: !0, value: r.sqrt(G * r.inv(P)) };
        } catch {
          return { isValid: !1, value: Ht };
        }
      }),
    D = t.adjustScalarBytes || ((G) => G),
    k =
      t.domain ||
      ((G, P, q) => {
        if (P.length || q)
    ...
    j = (G) => typeof G == "bigint" && Ht < G,
    X = (G, P) => j(G) && j(P) && G < P,
    rt = (G) => G === Ht || X(G, B);
  function mt(G, P) {
    if (X(G, P)) return G;
    throw new Error(`Expected valid scalar < ${P}, got ${typeof G} ${G}`);
  }
  function ot(G) {
    return G === Ht ? G : mt(G, o);
  }
  const nt = new Map();
  function St(G) {
    if (!(G instanceof Y)) throw new Error("ExtendedPoint expected");
  }
  class Y {
    constructor(P, q, C, H) {
      if (((this.ex = P), (this.ey = q), (this.ez = C), (this.et = H), !rt(P)))
        throw new Error("x required");
      if (!rt(q)) throw new Error("y required");
      if (!rt(C)) throw new Error("z required");
      if (!rt(H)) throw new Error("t required");
    }
    get x() {
    ...
    static fromAffine(P) {
      if (P instanceof Y) throw new Error("extended point not allowed");
      const { x: q, y: C } = P || {};
      if (!rt(q) || !rt(C)) throw new Error("invalid affine point");
      return new Y(q, C, Ct, N(q * C));
    }
    static normalizeZ(P) {
      const q = r.invertBatch(P.map((C) => C.ez));
      return P.map((C, H) => C.toAffine(q[H])).map(Y.fromAffine);
    }
    _setWindowSize(P) {
      (this._WINDOW_SIZE = P), nt.delete(this);
    }
    assertValidity() {
      const { a: P, d: q } = t;
      if (this.is0()) throw new Error("bad point: ZERO");
      const { ex: C, ey: H, ez: st, et: y } = this,
        dt = N(C * C),
        ut = N(H * H),
        gt = N(st * st),
        $ = N(gt * gt),
        ...
        w = N(gt * N(K + ut)),
        x = N($ + N(q * N(dt * ut)));
      if (w !== x) throw new Error("bad point: equation left != right (1)");
      const _ = N(C * H),
        T = N(st * y);
      if (_ !== T) throw new Error("bad point: equation left != right (2)");
    }
    equals(P) {
      St(P);
      const { ex: q, ey: C, ez: H } = this,
        { ex: st, ey: y, ez: dt } = P,
        ut = N(q * dt),
        gt = N(st * H),
        $ = N(C * dt),
    ...
    negate() {
      return new Y(N(-this.ex), this.ey, this.ez, N(-this.et));
    }
    double() {
      const { a: P } = t,
        { ex: q, ey: C, ez: H } = this,
        ...
        S = N($ * x),
        U = N(w * K);
      return new Y(_, T, U, S);
    }
    add(P) {
      St(P);
      const { a: q, d: C } = t,
        { ex: H, ey: st, ez: y, et: dt } = this,
        { ex: ut, ey: gt, ez: $, et: K } = P;
      if (q === BigInt(-1)) {
        const F = N((st - H) * (gt + ut)),
          O = N((st + H) * (gt - ut)),
          z = N(O - F);
        if (z === Ht) return this.double();
        const V = N(y * ke * K),
          et = N(dt * ke * $),
          h = et + V,
          s = O + F,
      ...
      const w = N(H * ut),
        ...
        p = N(S * n),
        E = N(U * f);
      return new Y(i, l, E, p);
    }
    subtract(P) {
      return this.add(P.negate());
    }
    wNAF(P) {
      return tt.wNAFCached(this, nt, P, Y.normalizeZ);
    }
    multiply(P) {
      const { p: q, f: C } = this.wNAF(mt(P, o));
      return Y.normalizeZ([q, C])[0];
    }
    multiplyUnsafe(P) {
      let q = ot(P);
      return q === Ht
        ...
        : this.equals(J) || q === Ct
          ...
          : this.equals(W)
            ? this.wNAF(q).p
            : tt.unsafeLadder(this, q);
    }
    isSmallOrder() {
      return this.multiplyUnsafe(b).is0();
    }
    isTorsionFree() {
      return tt.unsafeLadder(this, o).is0();
    }
    toAffine(P) {
      const { ex: q, ey: C, ez: H } = this,
        st = this.is0();
      P == null && (P = st ? Da : r.inv(H));
      const y = N(q * P),
        dt = N(C * P),
        ut = N(H * P);
      if (st) return { x: Ht, y: Ct };
      if (ut !== Ct) throw new Error("invZ was invalid");
      return { x: y, y: dt };
    }
    clearCofactor() {
      const { h: P } = t;
    ...
    static fromHex(P, q = !1) {
      ...
      y[st - 1] = dt & -129;
      const ut = He(y);
      ut === Ht || (q ? mt(ut, B) : mt(ut, r.ORDER));
      const gt = N(ut * ut),
        $ = N(gt - Ct),
        K = N(C * gt - H);
      let { isValid: w, value: x } = L($, K);
      if (!w) throw new Error("Point.fromHex: invalid y coordinate");
      const _ = (x & Ct) === Ct,
        T = (dt & 128) !== 0;
      if (!q && x === Ht && T) throw new Error("Point.fromHex: x=0 and x_0=1");
      return T !== _ && (x = N(-x)), Y.fromAffine({ x, y: ut });
    }
    static fromPrivateKey(P) {
      return yt(P).point;
    }
    toRawBytes() {
      const { x: P, y: q } = this.toAffine(),
        C = Ur(q, r.BYTES);
      return (C[C.length - 1] |= P & Ct ? 128 : 0), C;
    }
    toHex() {
      return Xr(this.toRawBytes());
    }
  }
  (Y.BASE = new Y(t.Gx, t.Gy, Ct, N(t.Gx * t.Gy))),
    (Y.ZERO = new Y(Ht, Ct, Ct, Ht));
  const { BASE: W, ZERO: J } = Y,
    tt = ca(Y, c * 8);
  function at(G) {
    return vt(G, o);
  }
  ...
  function yt(G) {
    const P = c;
    G = re("private key", G, P);
    const q = re("hashed private key", d(G), 2 * P),
      C = D(q.slice(0, P)),
      H = q.slice(P, 2 * P),
      st = M(C),
      y = W.multiply(st),
      dt = y.toRawBytes();
    return { head: C, prefix: H, scalar: st, point: y, pointBytes: dt };
  }
  function ht(G) {
    return yt(G).pointBytes;
  }
  function ft(G = new Uint8Array(), ...P) {
    const q = _n(...P);
    return M(d(k(q, re("context", G), !!u)));
  }
  function At(G, P, q = {}) {
    (G = re("message", G)), u && (G = u(G));
    const { prefix: C, scalar: H, pointBytes: st } = yt(P),
      y = ft(q.context, C, G),
      dt = W.multiply(y).toRawBytes(),
      ut = ft(q.context, dt, st, G),
      gt = at(y + ut * H);
    ot(gt);
    const $ = _n(dt, Ur(gt, r.BYTES));
    return re("result", $, c * 2);
  }
  const bt = Pa;
  function Pt(G, P, q, C = bt) {
    const { context: H, zip215: st } = C,
      y = r.BYTES;
    (G = re("signature", G, 2 * y)), (P = re("message", P)), u && (P = u(P));
    const dt = He(G.slice(y, 2 * y));
    let ut, gt, $;
    try {
      (ut = Y.fromHex(q, st)),
        (gt = Y.fromHex(G.slice(0, y), st)),
        ($ = W.multiplyUnsafe(dt));
    } catch {
      return !1;
    }
    if (!st && ut.isSmallOrder()) return !1;
    const K = ft(H, gt.toRawBytes(), ut.toRawBytes(), P);
    return gt
      .add(ut.multiplyUnsafe(K))
      .subtract($)
      .clearCofactor()
      .equals(Y.ZERO);
  }
  return (
    W._setWindowSize(8),
    {
      ...
      utils: {
        ...
        precompute(G = 8, P = Y.BASE) {
          return P._setWindowSize(G), P.multiply(BigInt(3)), P;
        },
      },
    }
  );
...
function Ha(e) {
  const t = Qr,
    ...
    L = (Wt(N, Un, t) * B) % t,
    D = (Wt(L, Tn, t) * g) % t;
  return { pow_p_5_8: (Wt(D, vr, t) * e) % t, b2: o };
}
function Ka(e) {
...
function Li(e, t, r) {
  ...
  return Bs(
    zn("SigEd25519 no Ed25519 collisions"),
    new Uint8Array([r ? 1 : 0, t.length]),
    t,
    e,
  );
}
({ ...tn });
({ ...tn });
const Ya = (Zt.ORDER + BigInt(3)) / BigInt(8);
Zt.pow(vr, Ya);
Zt.sqrt(Zt.neg(Zt.ONE));
(Zt.ORDER - BigInt(5)) / BigInt(8);
BigInt(486662);
aa(Zt, Zt.neg(BigInt(486664)));
BigInt(
...
const vn = Uint8Array.from([48, 5, 6, 3, 43, 101, 112]);
Uint8Array.from([
  48, 16, 6, 7, 42, 134, 72, 206, 61, 2, 1, 6, 5, 43, 129, 4, 0, 10,
]);
function qa(e, t) {
  const r = 2 + Nn(e.byteLength + 1),
    o = t.byteLength + r + e.byteLength;
  let u = 0;
  const d = new Uint8Array(1 + Nn(o) + o);
  return (
    (d[u++] = 48),
    (u += Fn(d, u, o)),
    d.set(t, u),
...
const Va = (e, t) => {
  ...
  const o = (c, b) => {
    ...
    u = new Uint8Array(e);
  if (
    (o(48, "sequence"), (r += Rr(u, r)), !ci(u.slice(r, r + t.byteLength), t))
  )
    throw new Error("Not the expected OID.");
  (r += t.byteLength), o(3, "bit string");
  const d = Wa(u, r) - 1;
  (r += Rr(u, r)), o(0, "0 padding");
  const g = u.slice(r);
  if (d !== g.length)
    throw new Error(
...
class jt {
  constructor(t) {
    ...
    Xe(this, Ke, t, "f"), Xe(this, ze, jt.derEncode(t), "f");
  }
  static from(t) {
    if (typeof t == "string") {
      const r = fe(t);
      ...
      const r = t;
      if (On(r) && Object.hasOwnProperty.call(r, "__derEncodedPublicKey__"))
        return this.fromDer(r);
      if (ArrayBuffer.isView(r)) {
        const o = r;
        return this.fromRaw(fi(o.buffer));
      } else {
...
class ue extends zr {
  constructor(t, r) {
    super(),
      xe.set(this, void 0),
      me.set(this, void 0),
      Xe(this, xe, jt.from(t), "f"),
      Xe(this, me, new Uint8Array(r), "f");
  }
  static generate(t) {
    if (t && t.length !== 32)
      throw new Error("Ed25519 Seed needs to be 32 bytes long.");
    t || (t = Ae.utils.randomPrivateKey()),
      ci(t, new Uint8Array(new Array(32).fill(0))) &&
        console.warn(
    ...
    const o = Ae.getPublicKey(r);
    return ue.fromKeyPair(o, r);
  }
  static fromParsedJson(t) {
    const [r, o] = t;
    return new ue(jt.fromDer(fe(r)), fe(o));
  }
  static fromJSON(t) {
  ...
  static fromKeyPair(t, r) {
    return new ue(jt.fromRaw(t), r);
  }
  static fromSecretKey(t) {
    const r = Ae.getPublicKey(new Uint8Array(t));
    return ue.fromKeyPair(r, t);
  }
  toJSON() {
    return [be(oe(this, xe, "f").toDer()), be(oe(this, me, "f"))];
  }
  getKeyPair() {
    return { secretKey: oe(this, me, "f"), publicKey: oe(this, xe, "f") };
  }
  getPublicKey() {
    return oe(this, xe, "f");
  }
  async sign(t) {
    const r = new Uint8Array(t),
      o = Te(Ae.sign(r, oe(this, me, "f").slice(0, 32)));
    return (
  ...
  static verify(t, r, o) {
    const [u, d, g] = [t, r, o].map(
      (c) => (
        typeof c == "string" && (c = fe(c)),
        c instanceof Uint8Array && (c = c.buffer),
        new Uint8Array(c)
      ),
    );
    return Ae.verify(d, u, g);
  }
}
(xe = new WeakMap()), (me = new WeakMap());
class en extends Error {
  constructor(t) {
    super(t), (this.message = t), Object.setPrototypeOf(this, en.prototype);
  }
}
function Dn(e) {
...
class je extends zr {
  ...
  async sign(t) {
    ...
    return (
      ...
      await this._subtleCrypto.sign(r, this._keyPair.privateKey, t)
    );
  }
}
var Ja = function (e, t, r, o, u) {
    if (o === "m") throw new TypeError("Private method is not writable");
    if (o === "a" && !u)
      throw new TypeError("Private accessor was defined without a setter");
    if (typeof t == "function" ? e !== t || !u : !t.has(e))
...
class Xa {
  constructor(t) {
    se.set(this, void 0), Ja(this, se, t, "f");
  }
  get rawKey() {
    return Se(this, se, "f").rawKey;
  }
  get derKey() {
    return Se(this, se, "f").derKey;
  }
  toDer() {
    return Se(this, se, "f").toDer();
  }
  getPublicKey() {
    return Se(this, se, "f");
  }
  getPrincipal() {
    return ce.from(Se(this, se, "f").rawKey);
  }
  transformRequest() {
...
var ja = function (e, t, r, o, u) {
  ...
  Ye;
const t0 = new TextEncoder().encode("ic-request-auth-delegation"),
  e0 = new TextEncoder().encode(`
ic-request`);
function dr(e) {
...
async function r0(e, t, r, o) {
  const u = new rn(t.toDer(), BigInt(+r) * BigInt(1e6), o),
    d = new Uint8Array([...t0, ...new Uint8Array(Kr(u))]),
    g = await e.sign(d);
...
class Ne {
  ...
  static async create(t, r, o = new Date(Date.now() + 15 * 60 * 1e3), u = {}) {
    var d, g;
    const c = await r0(t, r, o, u.targets);
    return new Ne(
      [
  ...
  static fromJSON(t) {
    ...
    const u = o.map((d) => {
      const { delegation: g, signature: c } = d,
        { pubkey: b, expiration: B, targets: N } = g;
    ...
    return Object.assign(Object.assign({}, o), {
      body: {
        ...
        sender_sig: await this.sign(
          new Uint8Array([...e0, ...new Uint8Array(u)]),
        ),
...
class Ze extends Xa {
  constructor(t, r) {
    super(t), Ye.set(this, void 0), ja(this, Ye, r, "f");
  }
  get delegation() {
    return Za(this, Ye, "f");
  }
...
const Cn = ["mousedown", "mousemove", "keydown", "touchstart", "wheel"];
class $n {
  constructor(t = {}) {
    var r;
    (this.callbacks = []),
    ...
    const g = (c, b) => {
      ...
      return (...N) => {
        const L = this,
          D = function () {
            (B = void 0), c.apply(L, N);
          };
        clearTimeout(B), (B = window.setTimeout(D, b));
      };
    };
    if (t?.captureScroll) {
      const c = g(
...
const n0 = (e, t) => t.some((r) => e instanceof r);
let kn, Gn;
function i0() {
  return (
    kn ||
...
function o0(e) {
  ...
  return (
    t
      .then((r) => {
        r instanceof IDBCursor && Di.set(r, e);
      })
      .catch(() => {}),
    nn.set(t, e),
    t
...
function c0(e) {
  return e === IDBDatabase.prototype.transaction &&
    ...
    ? function (t, ...r) {
        const o = e.call(wr(this), t, ...r);
        return Pi.set(o, t.sort ? t.sort() : [t]), he(o);
      }
    : s0().includes(e)
      ? function (...t) {
          return e.apply(wr(this), t), he(Di.get(this));
        }
      : function (...t) {
          return he(e.apply(wr(this), t));
        };
}
function f0(e) {
  return typeof e == "function"
    ? c0(e)
    : (e instanceof IDBTransaction && a0(e),
      n0(e, i0()) ? new Proxy(e, Or) : e);
}
function he(e) {
  if (e instanceof IDBRequest) return o0(e);
  if (pr.has(e)) return pr.get(e);
  const t = f0(e);
  return t !== e && (pr.set(e, t), nn.set(t, e)), t;
}
const wr = (e) => nn.get(e);
function h0(e, t, { blocked: r, upgrade: o, blocking: u, terminated: d } = {}) {
  const g = indexedDB.open(e, t),
    c = he(g);
  return (
    o &&
      g.addEventListener("upgradeneeded", (b) => {
        o(he(g.result), b.oldVersion, b.newVersion, he(g.transaction), b);
      }),
    ...
    c
      .then((b) => {
        d && b.addEventListener("close", () => d()),
          u &&
            b.addEventListener("versionchange", (B) =>
              u(B.oldVersion, B.newVersion, B),
            );
      })
      .catch(() => {}),
    c
...
const l0 = ["get", "getKey", "getAll", "getAllKeys", "count"],
  d0 = ["put", "add", "delete", "clear"],
  yr = new Map();
function Hn(e, t) {
  if (!(e instanceof IDBDatabase && !(t in e) && typeof t == "string")) return;
  if (yr.get(t)) return yr.get(t);
  ...
  const d = async function (g, ...c) {
    ...
    return (
      o && (B = B.index(c.shift())),
      (await Promise.all([B[r](...c), u && b.done]))[0]
    );
  };
  return yr.set(t, d), d;
}
u0((e) => ({
  ...e,
  get: (t, r, o) => Hn(t, r) || e.get(t, r, o),
  has: (t, r) => !!Hn(t, r) || e.has(t, r),
}));
const Mi = "auth-client-db",
  Ci = "ic-keyval",
  p0 = async (e = Mi, t = Ci, r) => (
    $i &&
      localStorage != null &&
      localStorage.getItem(Xt) &&
      (localStorage.removeItem(Xt), localStorage.removeItem(ae)),
    await h0(e, r, {
      upgrade: (o) => {
        o.objectStoreNames,
          o.objectStoreNames.contains(t) && o.clear(t),
          o.createObjectStore(t);
      },
    })
  );
async function w0(e, t, r) {
  return await e.get(t, r);
}
async function y0(e, t, r, o) {
  return await e.put(t, o, r);
}
async function g0(e, t, r) {
...
class sn {
  ...
  static async create(t) {
    const { dbName: r = Mi, storeName: o = Ci, version: u = E0 } = t ?? {},
      d = await p0(r, o, u);
    return new sn(d, o);
  }
  async set(t, r) {
    return await y0(this._db, this._storeName, t, r);
  }
  async get(t) {
    var r;
    return (r = await w0(this._db, this._storeName, t)) !== null && r !== void 0
      ? r
      : null;
  }
  async remove(t) {
    return await g0(this._db, this._storeName, t);
  }
}
var x0 = function (e, t, r, o, u) {
    if (o === "m") throw new TypeError("Private method is not writable");
    if (o === "a" && !u)
      throw new TypeError("Private accessor was defined without a setter");
    if (typeof t == "function" ? e !== t || !u : !t.has(e))
...
class ki {
  constructor(t) {
    We.set(this, void 0), x0(this, We, t ?? {}, "f");
  }
  get _db() {
...
We = new WeakMap();
const I0 = "https://identity.ic0.app",
  B0 = "#authorize",
  gr = "ECDSA",
  xr = "Ed25519",
  A0 = 500,
...
class T0 {
  ...
  static async create(t = {}) {
    var r, o, u;
    const d = (r = t.storage) !== null && r !== void 0 ? r : new ki(),
      g = (o = t.keyType) !== null && o !== void 0 ? o : gr;
    let c = null;
    if (t.identity) c = t.identity;
    else {
      let L = await d.get(ae);
      if (!L && $i)
        try {
          const D = new _0(),
            k = await D.get(Xt),
          ...
          console.error("error while attempting to recover localstorage: " + D);
        }
      if (L)
        try {
          typeof L == "object"
            ? g === xr && typeof L == "string"
              ? (c = await ue.fromJSON(L))
              : (c = await je.fromKeyPair(L))
            : typeof L == "string" && (c = ue.fromJSON(L));
        } catch {}
    }
    let b = new xn(),
      B = null;
      ...
      try {
        ...
        t.identity
          ...
          : L &&
            ...
            Oi(B)
              ? "toDer" in c
                ? (b = Ze.fromDelegation(c, B))
                : (b = Pn.fromDelegation(c, B))
              : (await mr(d), (c = null)));
      } catch (L) {
        console.error(L), await mr(d), (c = null);
      }
    let N;
    return (
      !((u = t.idleOptions) === null || u === void 0) && u.disableIdle
        ? (N = void 0)
        : (B || t.identity) && (N = $n.create(t.idleOptions)),
      c ||
        (g === xr
          ? ((c = await ue.generate()),
            await d.set(ae, JSON.stringify(c.toJSON())))
          : (t.storage &&
              g === gr &&
              console.warn(
                `You are using a custom storage provider that may not support CryptoKey storage. If you are using a custom storage provider that does not support CryptoKey storage, you should use '${xr}' as the key type, as it can serialize to a string`,
              ),
            (c = await je.generate()),
            await d.set(ae, c.getKeyPair()))),
      new this(b, c, B, d, N, t)
    );
  }
  ...
  async _handleSuccess(t, r) {
    ...
    const d = t.delegations.map((B) => ({
      ...
      g = Ne.fromDelegations(d, t.userPublicKey.buffer),
      c = this._key;
    if (!c) return;
    (this._chain = g),
      "toDer" in c
        ? (this._identity = Ze.fromDelegation(c, this._chain))
        : (this._identity = Pn.fromDelegation(c, this._chain)),
    ...
    !this.idleManager &&
      !b?.disableIdle &&
      ((this.idleManager = $n.create(b)), this._registerDefaultIdleCallback()),
  ...
  async logout(t = {}) {
    if (
      (await mr(this._storage),
      (this._identity = new xn()),
      (this._chain = null),
      t.returnTo)
    )
      try {
...
async function mr(e) {
  await e.remove(ae), await e.remove(Xt), await e.remove(b0);
}
const U0 = () =>
  T0.create({
...
let qe;
const N0 = () => (qe = setInterval(async () => await F0(), as)),
  Gi = () => {
    qe && (clearInterval(qe), (qe = void 0));
  },
  F0 = async () => {
    const [e, t] = await Promise.all([v0(), R0()]);
  ...
  v0 = async () => (await U0()).isAuthenticated(),
  R0 = async () => {
    const t = await new ki().get(Xt),
      r = t !== null ? Ne.fromJSON(t) : null;
    return { valid: r !== null && Oi(r), delegation: r };
  },
  L0 = () => {
    Gi(), postMessage({ msg: "signOutIdleTimer" });
  },
  O0 = (e) => {
